...
AppWizard has created this GeoTrans application for you.  This application
...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in GeoTrans.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////

AppWizard creates one document type and one view:

GeoTransDoc.h, GeoTransDoc.cpp - the document
    These files contain your CGeoTransDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CGeoTransDoc::Serialize).

GeoTransView.h, GeoTransView.cpp - the view of the document
...
StdAfx.h, StdAfx.cpp
    ...
    named GeoTrans.pch and a precompiled types file named StdAfx.obj.
